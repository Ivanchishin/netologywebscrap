...
1. При поиске вакансий, selenium находит только вакансии первой половине странице, остальные игнорируются, хотя используется прокрутка страницы вниз для отображения всех вакансий.
